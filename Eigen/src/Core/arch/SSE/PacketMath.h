...
template<> EIGEN_STRONG_INLINE float  pfirst<Packet4f>(const Packet4f& a) { return 0; }
template<> EIGEN_STRONG_INLINE double pfirst<Packet2d>(const Packet2d& a) { return 0; }
